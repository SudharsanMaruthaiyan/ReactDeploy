...
const ProductDetails = () => {
  ...
  const { ProductDetailsData, isLoading } = useFetchProductById(productData);
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
            <div className="shrink-0 max-w-md lg:max-w-lg mx-auto">
              <img
                ...
                alt={ProductDetailsData?.title || "Product image"}
              />
              <img
            ...
            <div className="mt-6 sm:mt-8 lg:mt-0">
              <h1 className="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">
                {ProductDetailsData?.title || "Loading..."}
              </h1>
              ...
              <div className="mt-4 sm:items-center sm:gap-4 sm:flex">
                ...
                <div className="flex items-center gap-2 mt-2 sm:mt-0">
                  ...
                  {/* You can optionally show number of reviews if present */}
              ...
              <div className="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
                ...
                <a
                  ...
                  onClick={(e) => {
                    ...
                    // Optionally show some feedback or navigate to cart.
                  }}
                >
                  <svg
                    className="w-5 h-5 -ms-2 me-2"
              ...
              <p className="text-gray-500 dark:text-gray-400">
                {/* Optionally: Render category, brand, etc. */}
